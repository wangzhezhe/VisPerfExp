...
DATADIR=/pscratch/sd/z/zw241/zw241/VisPerfStudy/dataset/isabel
RUNDIR=/pscratch/sd/z/zw241/zw241/VisPerfStudy/Results/VisPerfExpSl2_Isabel244_Rank32_Nxyz2_${1}
CURRDIR=$(pwd)
...
echo "executing isabel on dataset ${3} execution index is ${4} strategy ${5}"
...
--advect-seed-box-extents=0.01,498.9,0.01,498.9,0.01,98.9 \
--field-name=Velocity \
...
DATA_NAME=fb_isabel_0.2_4_4.128_128_128.visit
...
estimate_log_file_1=sl2_estimate_isabel_1thread_${log_suffix}
estimate_log_file_32=sl2_estimate_isabel_32thread_${log_suffix}

parser_log=parser_log.log

export OMP_NUM_THREADS=1
srun -N $NUM_NODE -n $NUM_RANK ./StreamlineMPI2 $DATADIR/${DATA_NAME} Velocity $STEPSIZE_ISABEL $MAXSTEPS $NUM_TEST_POINTS $NUM_SIM_POINTS_PER_DOM $NXYZ &> ${estimate_log_file_1}
