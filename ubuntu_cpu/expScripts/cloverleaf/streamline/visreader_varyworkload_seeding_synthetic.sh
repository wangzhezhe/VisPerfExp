...
# this script vary the workload and seeding strategy
# and it use the seeding along a line
rm -rf ./visreader_varyworkload_seeding_synthetic_data
...
# create soft link
mkdir visreader_varyworkload_seeding_synthetic_data
cd visreader_varyworkload_seeding_synthetic_data
...
# 1000000 takes too long to complete
...
--file=$DATASET \
--field-name=velocity \
--advect-seed-box-extents=20,22,20,22,0,96 \
