...
#BSUB -J clover_vary_procs_mediumbox
#BSUB -o R_clover_vary_procs_mediumbox.%J.out
#BSUB -e R_clover_vary_procs_mediumbox.%J.err 
...
DATA_DIRNAME=clover_vary_procs_mediumbox/x_cloverleafRaw_128_128_256.640.4_4_4.128_128_128
...
--file=$DATASET \
--field-name=$FIELD \
--advect-seed-box-extents=1,3,1,3,2,6 \
