...
#BSUB -J InlineVarySeeds_8_Procs
#BSUB -o R_InlineVarySeeds_8_Procs.%J.out
#BSUB -e R_InlineVarySeeds_8_Procs%J.err 


CURRDIR=$(pwd)
DATA_DIRNAME=InlineVarySeeds_8_Procs_Data
...
jsrun -n 8 ./cloverleaf3d_par &> sim.log
