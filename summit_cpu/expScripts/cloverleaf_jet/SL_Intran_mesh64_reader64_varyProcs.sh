...
#BSUB -J SL_Intran_mesh64_reader64_varyProcs
#BSUB -o R_SL_Intran_mesh64_reader64_varyProcs.%J.out
#BSUB -e R_SL_Intran_mesh64_reader64_varyProcs.%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=SL_Intran_mesh64_reader64_varyProcs_Data
