...
#BSUB -J SL_Intran_mesh256_varyProcs
#BSUB -o R_SL_Intran_mesh256_varyProcs.%J.out
#BSUB -e R_SL_Intran_mesh256_varyProcs%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=SL_Intran_mesh256_varyProcs_Data
...
NUM_SIM_PROC_LIST="128"
NUM_SEEDS_LIST="1000"
NUM_READER_PROC_LIST="2 4 8 16 32 64 128"
...
sed -i "s/end_step=600/end_step=400/" clover.in
...
sed -i "s/endstep: 10/endstep: 400/" ascent_actions.yaml
