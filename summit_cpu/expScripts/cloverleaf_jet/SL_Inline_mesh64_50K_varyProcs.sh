...
#BSUB -J SL_Inline_mesh64_50K_varyProcs
#BSUB -o R_SL_Inline_mesh64_50K_varyProcs.%J.out
#BSUB -e R_SL_Inline_mesh64_50K_varyProcs.%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=SL_Inline_mesh64_50K_varyProcs
...
NUM_PROCS_LIST="1024 512 256 128 64 32"
