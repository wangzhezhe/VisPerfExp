...
#BSUB -J SL_Intran_mesh64_reader512_varyProcs
#BSUB -o R_SL_Intran_mesh64_reader512_varyProcs.%J.out
#BSUB -e R_SL_Intran_mesh64_reader512_varyProcs.%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=SL_Intran_mesh64_reader512_varyProcs_Data
...
NUM_SIM_PROC_LIST="1024 512"
NUM_SEEDS_LIST="1000"
NUM_READER_PROC_LIST="512"
