...
#BSUB -J SL_Intran_mesh64_reader128_varyProcs
#BSUB -o R_SL_Intran_mesh64_reader128_varyProcs.%J.out
#BSUB -e R_SL_Intran_mesh64_reader128_varyProcs.%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=SL_Intran_mesh64_reader128_varyProcs_Data
