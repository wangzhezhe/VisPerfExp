...
#BSUB -J reader_vary_procs_seeds_cpu_32_whole
#BSUB -o R_reader_vary_procs_seeds_cpu_32_whole.%J.out
#BSUB -e R_reader_vary_procs_seeds_cpu_32_whole.%J.err 
...
DATA_DIRNAME=reader_vary_procs_seeds_cpu_32_whole/$DATANAME
