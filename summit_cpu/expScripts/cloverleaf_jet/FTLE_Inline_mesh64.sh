...
#BSUB -J FTLE_Inline_mesh64
#BSUB -o R_FTLE_Inline_mesh64.%J.out
#BSUB -e R_FTLE_Inline_mesh64%J.err 

CURRDIR=$(pwd)
DATA_DIRNAME=FTLE_Inline_mesh64_Data
...
sed -i "s/num_steps: 512/num_steps: 20/" ascent_actions.yaml
