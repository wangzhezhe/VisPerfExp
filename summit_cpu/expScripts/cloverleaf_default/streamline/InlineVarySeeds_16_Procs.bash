...
#BSUB -J InlineVarySeeds_16_Procs
#BSUB -o R_InlineVarySeeds_16_Procs.%J.out
#BSUB -e R_InlineVarySeeds_16_Procs%J.err 


CURRDIR=$(pwd)
DATA_DIRNAME=InlineVarySeeds_16_Procs_Data
