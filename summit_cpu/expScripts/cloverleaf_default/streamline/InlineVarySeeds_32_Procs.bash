...
#BSUB -J InlineVarySeeds_32_Procs
#BSUB -o R_InlineVarySeeds_32_Procs.%J.out
#BSUB -e R_InlineVarySeeds_32_Procs%J.err 


CURRDIR=$(pwd)
DATA_DIRNAME=InlineVarySeeds_32_Procs_Data
