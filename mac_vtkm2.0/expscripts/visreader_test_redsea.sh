...
# create soft link
mkdir -p visreader_test_redsea_data

cd visreader_test_redsea_data
...
# for cloverleaf data
DATADIR=/Users/zw1/Documents/Datasets/RedSeaRaw
DATANAME="fb_RedSea0001.2_2_2.128_128_64.visit"
...
--file=$DATASET \
--field-name=velocity \
--advect-seed-box-extents=.01,498.9,0.01,498.9,0.01,49.9 \
