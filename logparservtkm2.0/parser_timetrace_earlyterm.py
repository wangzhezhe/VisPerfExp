...
if __name__ == "__main__":
    ...
    fig.savefig("rank_gantt_all_earlyterm_800.png",bbox_inches='tight',dpi=800)
    fig.savefig("rank_gantt_all_earlyterm_100.png",bbox_inches='tight',dpi=100)
    fig.savefig("rank_gantt_all_earlyterm.pdf",bbox_inches='tight')