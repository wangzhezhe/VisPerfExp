...
if __name__ == "__main__":
    ...
    if len(sys.argv)!=4:
        print("<binary> <actual run parser log> <block num> <proc num>",flush=True)
        exit()
    ...
    put_workload_into_bin_2(sorted_adv_popularity,bin_remaining_space_list, block_list_for_proc)
    ...
    # efficiency can be checked by remaining_space_list 
